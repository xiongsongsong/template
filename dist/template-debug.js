...
define("arale/template/1.0.0/split-debug", [], function (require, exports, module) {
...
define("arale/template/1.0.0/json2-debug", [], function (require, exports, module) {
...
define("arale/template/1.0.0/template-debug", ["./split-debug", "./json2-debug"], function (require, exports, module) {
                ...
                if (IF_FLAG.test(_str)) {
                    ...
                    //匹配Each语句
                        ...
                        html += _str.replace(forEachRe, function (_str) {
                            ...
                            var $1 = match[1].split(',');
                            var $2 = match[2];
                            var i = $1.length > 1 ? $1[1] : 'index' + parseInt(Math.random() * 18888);
